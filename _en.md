...
> Updated: 2026-07-30 19:54 UTC · Total: 69
...
> [!info]
> ⭐ 70,733 · Jupyter Notebook · 2026-07-29  
...
> [!info]
> ⭐ 32,505 · Jupyter Notebook · 2026-05-06  
...
> [!info]
> ⭐ 12,396 · TypeScript · 2026-07-30  
> [GitHub](https://github.com/codexu/note-gen) · [Website](https://notegen.top)  
> `#AI 智能体` `#Knowledge Management` `#Markdown` `#agent` `#ai-notes` `#knowledge-base` `#knowledge-management` `#llm` `#local-first` `#markdown` `#markdown-editor` `#mcp` `#nextjs` `#note-taking` `#rag` `#tauri` `#webdav` 
